...
def _seed_on_startup():
    ...
    try:
        ...
        SEED_MODELS = [
            ...
            dict(display_name="Claude Haiku 4.5 (Analyst)", model_id="claude-haiku-4-5-20251001", provider="Anthropic",
                 tier=2, cost_input_per_1m=0.80,  cost_output_per_1m=4.00,
                 is_enabled=True, is_default=True,
                 notes="Analyst tier — moderate complexity, single-signal routing (keyword or length)"),
